...
Lubrificantes e materiais de manutenção: utilizados periodicamente na manutenção dos componentes mecânicos da estação e do drone.
Principais recursos consumidos pelo sistema SCADA

Para o nosso projeto de automação e supervisão, também é interessante destacar os recursos consumidos pelo próprio sistema:

Energia elétrica da estação: alimentação do PLC, sensores, bomba e válvulas.
Energia da bateria do drone: alimentação dos motores, ESP32, sensores, GPS, comunicação e bomba.
Dados de telemetria: informações de nível, pressão, vazão, bateria, altitude, GPS, velocidade e condições ambientais.
Armazenamento de dados: espaço utilizado para o data logging das variáveis e eventos.
Comunicação sem fio: recurso utilizado para transmissão de dados entre o drone, a estação de solo e o servidor SCADA.
